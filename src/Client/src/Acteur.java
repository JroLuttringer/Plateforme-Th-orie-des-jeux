...
/* Classe Acteur 
Contient les fonctions communes à tous les acteurs 
( producteurs, coordinateurs, Joueurs)
*/

public abstract class Acteur extends UnicastRemoteObject implements Remote {
    protected String m_nom;
    protected String m_addr;
    protected String log = ""; // log des actions du joueur
    protected Timer timer; // Permet de faire effectuer périodiquement des actions au joueurs
    protected boolean my_turn = false; // nécessaire au tour par tour
    protected boolean finished = false; // idem
